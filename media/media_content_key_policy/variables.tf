...
#   playready_configuration_license (string): One or more 'playready_configuration_license' blocks.
...
#   alternate_key (string)                     : One or more 'alternate_key' block.
...
#   required_claim (string)                    : One or more 'required_claim' blocks.
