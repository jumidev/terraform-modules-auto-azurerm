...
inputs = {
   ...
   name = "The name which should be used for this Transform"   
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `jpg` | [block](#jpg-block-structure) | No | - | A 'jpg' block. |
| `mp4` | [block](#mp4-block-structure) | No | - | A 'mp4' block. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `audio_analyzer_preset` | [block](#audio_analyzer_preset-block-structure) | No | - | An 'audio_analyzer_preset' block. |
| `builtin_preset` | [block](#builtin_preset-block-structure) | No | - | A 'builtin_preset' block. |
| `custom_preset` | [block](#custom_preset-block-structure) | No | - | A 'custom_preset' block. |
| `face_detector_preset` | [block](#face_detector_preset-block-structure) | No | - | A 'face_detector_preset' block. |
