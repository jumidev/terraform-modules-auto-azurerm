...
| `crop_rectangle` | block | No | - | A 'crop_rectangle' block. |
...
| `position` | block | No | - | A 'position' block. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `audio` | block | No | - | An 'audio' block. |
| `video` | block | No | - | A 'video' block. |
...
| `output_file` | block | No | - | One or more 'output_file' blocks. |
...
| `preset_configuration` | block | No | - | A 'preset_configuration' block. |
...
| `format` | block | Yes | - | One or more 'format' blocks. |
| `experimental_options` | string | No | - | Dictionary containing key value pairs for parameters not exposed in the preset itself. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `jpg` | block | No | - | A 'jpg' block. |
| `mp4` | block | No | - | A 'mp4' block. |
| `png` | block | No | - | A 'png' block. |
| `transport_stream` | block | No | - | A 'transport_stream' block. |
...
| ---- | ---- | --------- | ------- | ----------- |
| `crop_rectangle` | block | No | - | A 'crop_rectangle' block. |
| `deinterlace` | block | No | - | A 'deinterlace' block. |
| `fade_in` | block | No | - | A 'fade_in' block. |
| `fade_out` | block | No | - | A 'fade_out' block. |
| `overlay` | block | No | - | One or more 'overlay' blocks. |
