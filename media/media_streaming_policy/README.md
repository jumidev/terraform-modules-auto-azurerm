...
| ---- | ---- | --------- | ------- | ----------- |
| `condition` | block | Yes | - | One or more 'condition' blocks. Changing this forces a new Streaming Policy to be created. |
...
| `track` | block | Yes | - | One or more 'track' blocks. Changing this forces a new Streaming Policy to be created. |
