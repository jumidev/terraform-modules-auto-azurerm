...
| ---- | --------- |  ----------- |
| **var.media_services_account_name** | string |  The Media Services account name. Changing this forces a new Streaming Policy to be created. | 
| **var.name** | string |  The name which should be used for this Streaming Policy. Changing this forces a new Streaming Policy to be created. | 
| **var.resource_group_name** | string |  The name of the Resource Group where the Streaming Policy should exist. Changing this forces a new Streaming Policy to be created. | 
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `clear_key_encryption` | [block](#common_encryption_cenc-block-structure) | No | - | A 'clear_key_encryption' block. Changing this forces a new Streaming Policy to be created. |
| `clear_track` | [block](#common_encryption_cenc-block-structure) | No | - | One or more 'clear_track' blocks. Changing this forces a new Streaming Policy to be created. |
| `content_key_to_track_mapping` | [block](#common_encryption_cenc-block-structure) | No | - | One or more 'content_key_to_track_mapping' blocks. Changing this forces a new Streaming Policy to be created. |
| `default_content_key` | [block](#common_encryption_cenc-block-structure) | No | - | A 'default_content_key' block. Changing this forces a new Streaming Policy to be created. |
| `drm_playready` | [block](#common_encryption_cenc-block-structure) | No | - | A 'drm_playready' block. Changing this forces a new Streaming Policy to be created. |
