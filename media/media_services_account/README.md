...
| **var.key_delivery_access_control** | [block](#key_delivery_access_control-block-structure) |  -  |  A `key_delivery_access_control` block. | 
...
| `managed_identity` | [block](#storage_account-block-structure) | No | - | A 'managed_identity' block. |
