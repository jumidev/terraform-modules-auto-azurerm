...
| `ip_allow_list` | string | No | - | One or more IP Addresses, or CIDR Blocks which should be able to access the Key Delivery. |
...
| `identity_ids` | list | No | - | Specifies a list of User Assigned Managed Identity IDs to be assigned to this Media Services Account. |
