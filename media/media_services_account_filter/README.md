...
| **var.presentation_time_range** | block | False | A `presentation_time_range` block. | | `presentation_time_range` block structure: || 
...
| **var.track_selection** | block | False | One or more `track_selection` blocks. | | `track_selection` block structure: || 
