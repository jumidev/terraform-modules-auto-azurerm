...
inputs = {
   # api_management_logger_id → set in component_inputs
   # api_management_name → set in component_inputs
   api_name = "The name of the API on which to configure the Diagnostics Logs..."   
   identifier = "Identifier of the Diagnostics Logs"   
...
| `headers_to_log` | list | No | - | Specifies a list of headers to log. |
