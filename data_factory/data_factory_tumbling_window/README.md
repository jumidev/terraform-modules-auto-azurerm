...
| **var.pipeline** | block | True | -  |  -  |  A `pipeline` block. | | `pipeline` block structure: || 
...
| **var.retry** | block | False | -  |  -  |  A `retry` block. | | `retry` block structure: || 
...
| **var.trigger_dependency** | block | False | -  |  -  |  One or more `trigger_dependency` block. | | `trigger_dependency` block structure: || 
