...
| **var.catalog_info** | block | False | -  |  -  |  A `catalog_info` block. | | `catalog_info` block structure: || 
...
| **var.custom_setup_script** | block | False | -  |  -  |  A `custom_setup_script` block. | | `custom_setup_script` block structure: || 
...
| **var.express_custom_setup** | block | False | -  |  -  |  An `express_custom_setup` block. | | `express_custom_setup` block structure: || 
...
| **var.express_vnet_integration** | block | False | -  |  -  |  A `express_vnet_integration` block. | | `express_vnet_integration` block structure: || 
|   subnet_id (string): (REQUIRED) id of the subnet to which the nodes of the Azure-SSIS Integration Runtime will be added. ||

| **var.package_store** | block | False | -  |  -  |  One or more `package_store` block. | | `package_store` block structure: || 
...
| **var.vnet_integration** | block | False | -  |  -  |  A `vnet_integration` block. | | `vnet_integration` block structure: || 
