...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `command_key` | block | No | - | One or more 'command_key' blocks. |
| `component` | block | No | - | One or more 'component' blocks. |
...
| `key_vault_password` | block | No | - | A 'key_vault_secret_reference' block. |
...
| `key_vault_license` | block | No | - | A 'key_vault_secret_reference' block. |
