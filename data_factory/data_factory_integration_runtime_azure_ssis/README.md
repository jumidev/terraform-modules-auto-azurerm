...
| ---- | --------- |  ----------- | ----------- | ----------- |
| **number_of_nodes** | int |  `1`  |  -  |  Number of nodes for the Azure-SSIS Integration Runtime. Max is `10`. Defaults to `1`. | 
...
| `key_vault_license` | [block](#component-block-structure) | No | - | A 'key_vault_secret_reference' block. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `command_key` | [block](#express_custom_setup-block-structure) | No | - | One or more 'command_key' blocks. |
| `component` | [block](#express_custom_setup-block-structure) | No | - | One or more 'component' blocks. |
...
| `key_vault_password` | [block](#command_key-block-structure) | No | - | A 'key_vault_secret_reference' block. |
