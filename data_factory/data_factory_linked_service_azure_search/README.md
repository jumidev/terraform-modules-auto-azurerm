...
| **var.url** | string |  The URL of the Search Service endpoint (e.g. <https://{searchServiceName}.search.windows.net>). | 
| **var.search_service_key** | string |  The key of the Azure Search Service. | 
