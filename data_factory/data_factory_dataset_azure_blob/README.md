...
| **path** | string |  -  |  The path of the Azure Blob. | 
| **filename** | string |  -  |  The filename of the Azure Blob. | 
| **dynamic_path_enabled** | bool |  `False`  |  Is the `path` using dynamic expression, function or system variables? Defaults to `false`. | 
| **dynamic_filename_enabled** | bool |  `False`  |  Is the `filename` using dynamic expression, function or system variables? Defaults to `false`. | 
