...
inputs = {
   ...
   connection_string = "The connection string in which to authenticate with Snowflake..."   
}
...
| **connection_string** | string |  The connection string in which to authenticate with Snowflake. | 
...
| **key_vault_password** | [block](#key_vault_password-block-structure) |  A `key_vault_password` block. Use this argument to store Snowflake password in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service. | 
