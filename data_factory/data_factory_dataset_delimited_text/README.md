...
| **var.azure_blob_fs_location** | block | False | -  |  -  |  An `azure_blob_fs_location` block. | | `azure_blob_fs_location` block structure: || 
...
| **var.azure_blob_storage_location** | block | False | -  |  -  |  An `azure_blob_storage_location` block. | | `azure_blob_storage_location` block structure: || 
