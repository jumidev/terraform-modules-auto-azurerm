...
| **var.identity** | block | False | An `identity` block. Changing this forces a new Machine Learning Inference Cluster to be created. | | `identity` block structure: || 
...
| **var.ssl** | block | False | A `ssl` block. Changing this forces a new Machine Learning Inference Cluster to be created. | | `ssl` block structure: || 
