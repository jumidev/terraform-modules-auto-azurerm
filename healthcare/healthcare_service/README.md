...
| **var.authentication_configuration** | block | False | -  |  An `authentication_configuration` block. | | `authentication_configuration` block structure: || 
...
| **var.cors_configuration** | block | False | -  |  A `cors_configuration` block. | | `cors_configuration` block structure: || 
