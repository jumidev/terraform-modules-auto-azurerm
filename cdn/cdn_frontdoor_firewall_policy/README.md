...
| **var.custom_rule** | block | False | -  |  -  |  One or more `custom_rule` blocks. | | `custom_rule` block structure: || 
...
| **var.managed_rule** | block | False | -  |  -  |  One or more `managed_rule` blocks. | | `managed_rule` block structure: || 
