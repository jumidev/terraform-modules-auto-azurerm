...
| **var.agent_setting** | [block](#agent_setting-block-structure) |  -  |  A `agent_setting` block. | 
...
| **var.docker_step** | [block](#docker_step-block-structure) |  -  |  A `docker_step` block. | 
| **var.encoded_step** | [block](#encoded_step-block-structure) |  -  |  A `encoded_step` block. | 
| **var.file_step** | [block](#file_step-block-structure) |  -  |  A `file_step` block. | 
| **var.base_image_trigger** | [block](#base_image_trigger-block-structure) |  -  |  A `base_image_trigger` block. | 
| **var.source_trigger** | [block](#source_trigger-block-structure) |  -  |  One or more `source_trigger` blocks. | 
| **var.timer_trigger** | [block](#timer_trigger-block-structure) |  -  |  One or more `timer_trigger` blocks. | 
...
| **var.registry_credential** | [block](#registry_credential-block-structure) |  -  |  One `registry_credential` block. | 
...
| `expire_in_seconds` | int | No | - | Time in seconds that the token remains valid. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `source` | [block](#registry_credential-block-structure) | No | - | One 'source' block. |
...
| `authentication` | [block](#source_trigger-block-structure) | No | - | A 'authentication' block. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `cpu` | int | Yes | - | The number of cores required for the Container Registry Task. |
