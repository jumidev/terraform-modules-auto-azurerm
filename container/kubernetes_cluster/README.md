...
inputs = {
   ...
   default_node_pool = {
      name = "..."      
      vm_size = "..."      
      # capacity_reservation_group_id → (optional) set in tfstate_inputs
      # host_group_id → (optional) set in tfstate_inputs
      # node_public_ip_prefix_id → (optional) set in tfstate_inputs
      # pod_subnet_id → (optional) set in tfstate_inputs
      # proximity_placement_group_id → (optional) set in tfstate_inputs
      # snapshot_id → (optional) set in tfstate_inputs
      # vnet_subnet_id → (optional) set in tfstate_inputs
   }
