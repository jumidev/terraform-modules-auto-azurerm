...
| **var.default_node_pool** | [block](#default_node_pool-block-structure) |  A `default_node_pool` block. | 
...
| **var.aci_connector_linux** | [block](#aci_connector_linux-block-structure) |  -  |  -  |  A `aci_connector_linux` block. For more details, please visit [Create and configure an AKS cluster to use virtual nodes](https://docs.microsoft.com/azure/aks/virtual-nodes-portal). | 
...
| **var.api_server_access_profile** | [block](#api_server_access_profile-block-structure) |  -  |  -  |  An `api_server_access_profile` block. | 
| **var.auto_scaler_profile** | [block](#auto_scaler_profile-block-structure) |  -  |  -  |  A `auto_scaler_profile` block. | 
| **var.azure_active_directory_role_based_access_control** | [block](#azure_active_directory_role_based_access_control-block-structure) |  -  |  -  |  A `azure_active_directory_role_based_access_control` block. | 
...
| **var.confidential_computing** | [block](#confidential_computing-block-structure) |  -  |  -  |  A `confidential_computing` block. For more details please [the documentation](https://learn.microsoft.com/en-us/azure/confidential-computing/confidential-nodes-aks-overview) | 
...
| **var.http_proxy_config** | [block](#http_proxy_config-block-structure) |  -  |  -  |  A `http_proxy_config` block. | 
| **var.identity** | [block](#identity-block-structure) |  -  |  -  |  An `identity` block. One of either `identity` or `service_principal` must be specified. | 
...
| **var.ingress_application_gateway** | [block](#ingress_application_gateway-block-structure) |  -  |  -  |  A `ingress_application_gateway` block. | 
| **var.key_management_service** | [block](#key_management_service-block-structure) |  -  |  -  |  A `key_management_service` block. For more details, please visit [Key Management Service (KMS) etcd encryption to an AKS cluster](https://learn.microsoft.com/en-us/azure/aks/use-kms-etcd-encryption). | 
| **var.key_vault_secrets_provider** | [block](#key_vault_secrets_provider-block-structure) |  -  |  -  |  A `key_vault_secrets_provider` block. For more details, please visit [Azure Keyvault Secrets Provider for AKS](https://docs.microsoft.com/azure/aks/csi-secrets-store-driver). | 
| **var.kubelet_identity** | [block](#kubelet_identity-block-structure) |  -  |  -  |  A `kubelet_identity` block. | 
...
| **var.linux_profile** | [block](#linux_profile-block-structure) |  -  |  -  |  A `linux_profile` block. | 
...
| **var.maintenance_window_auto_upgrade** | [block](#maintenance_window_auto_upgrade-block-structure) |  -  |  -  |  A `maintenance_window_auto_upgrade` block. | 
| **var.maintenance_window_node_os** | [block](#maintenance_window_node_os-block-structure) |  -  |  -  |  A `maintenance_window_node_os` block. | 
| **var.microsoft_defender** | [block](#microsoft_defender-block-structure) |  -  |  -  |  A `microsoft_defender` block. | 
| **var.monitor_metrics** | [block](#monitor_metrics-block-structure) |  -  |  -  |  Specifies a Prometheus add-on profile for the Kubernetes Cluster. A `monitor_metrics` block. | 
| **var.network_profile** | [block](#network_profile-block-structure) |  -  |  -  |  A `network_profile` block. Changing this forces a new resource to be created. | 
...
| **var.oms_agent** | [block](#oms_agent-block-structure) |  -  |  -  |  A `oms_agent` block. | 
...
| **var.service_mesh_profile** | [block](#service_mesh_profile-block-structure) |  -  |  -  |  A `service_mesh_profile` block. | 
| **var.workload_autoscaler_profile** | [block](#workload_autoscaler_profile-block-structure) |  -  |  -  |  A `workload_autoscaler_profile` block defined below. | 
...
| **var.service_principal** | [block](#service_principal-block-structure) |  -  |  -  |  A `service_principal` block. One of either `identity` or `service_principal` must be specified. | 
...
| **var.storage_profile** | [block](#storage_profile-block-structure) |  -  |  -  |  A `storage_profile` block. | 
| **var.tags** | map |  -  |  -  |  A mapping of tags to assign to the resource. | 
| **var.web_app_routing** | [block](#web_app_routing-block-structure) |  -  |  -  |  A `web_app_routing` block. | 
| **var.windows_profile** | [block](#windows_profile-block-structure) |  -  |  -  |  A `windows_profile` block. | 
