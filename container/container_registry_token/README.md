...
| ---- | ---- | --------- | -------- | ----------- | ----------- |
| **name** | string | True | -  |  -  | Specifies the name of the token. Changing this forces a new resource to be created. | 
...
| **scope_map_id** | string | True | -  |  -  | The ID of the Container Registry Scope Map associated with the token. | 
| **enabled** | bool | False | `True`  |  -  | Should the Container Registry token be enabled? Defaults to `true`. | 
