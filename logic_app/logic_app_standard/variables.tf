...
#   app_scale_limit (number)               : The number of workers this Logic App can scale out to. Only applicable to apps on the Consumption and Premium plan.
...
#   elastic_instance_minimum (number)      : The number of minimum instances for this Logic App Only affects apps on the Premium plan.
