...
#   minutes (number)        : A list containing a single item which specifies the Minute interval at which this recurrence should be triggered.
#   month_days (number)     : A list of days of the month that the job should execute on.
#   monthly (block)         : A 'monthly' block.
#   week_days (number)      : A list of days of the week that the job should execute on. Possible values are 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday' and 'Saturday'.
#
