...
| **var.endpoint** | block | False | -  |  An `endpoint` block. | | `endpoint` block structure: || 
...
| **var.fallback_route** | block | False | -  |  A `fallback_route` block. If the fallback route is enabled, messages that don't match any of the supplied routes are automatically sent to this route. Defaults to messages/events. | | `fallback_route` block structure: || 
...
| **var.file_upload** | block | False | -  |  A `file_upload` block. | | `file_upload` block structure: || 
...
| **var.route** | block | False | -  |  A `route` block. | | `route` block structure: || 
...
| **var.enrichment** | block | False | -  |  A `enrichment` block. | | `enrichment` block structure: || 
...
| **var.cloud_to_device** | block | False | -  |  A `cloud_to_device` block. | | `cloud_to_device` block structure: || 
