...
| **var.endpoint** | [block](#endpoint-block-structure) |  -  |  An `endpoint` block. | 
| **var.fallback_route** | [block](#fallback_route-block-structure) |  -  |  A `fallback_route` block. If the fallback route is enabled, messages that don't match any of the supplied routes are automatically sent to this route. Defaults to messages/events. | 
| **var.file_upload** | [block](#file_upload-block-structure) |  -  |  A `file_upload` block. | 
| **var.identity** | [block](#identity-block-structure) |  -  |  An `identity` block. | 
| **var.network_rule_set** | [block](#network_rule_set-block-structure) |  -  |  A `network_rule_set` block. | 
| **var.route** | [block](#route-block-structure) |  -  |  A `route` block. | 
| **var.enrichment** | [block](#enrichment-block-structure) |  -  |  A `enrichment` block. | 
| **var.cloud_to_device** | [block](#cloud_to_device-block-structure) |  -  |  A `cloud_to_device` block. | 
...
| `feedback` | block | No | - | A 'feedback' block. |
