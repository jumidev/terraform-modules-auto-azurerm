...
| **var.request** | block | True | -  |  -  |  A `request` block. | | `request` block structure: || 
...
| **var.validation_rules** | block | False | -  |  -  |  A `validation_rules` block. | | `validation_rules` block structure: || 
