...
| **zones** | list |  -  |  -  |  Specifies a list of Availability Zones in which this Redis Cache should be located. Changing this forces a new Redis Cache to be created. | 
...
| `storage_account_subscription_id` | string | No | - | The ID of the Subscription containing the Storage Account. |
