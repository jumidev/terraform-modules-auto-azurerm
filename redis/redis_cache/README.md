...
| `data_persistence_authentication_method` | string | No | SAS | Preferred auth method to communicate to storage account used for data persistence. Possible values are 'SAS' and 'ManagedIdentity'. Defaults to 'SAS'. |
