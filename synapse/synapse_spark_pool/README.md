...
| **var.auto_scale** | block | False | -  |  -  |  An `auto_scale` block. Exactly one of `node_count` or `auto_scale` must be specified. | | `auto_scale` block structure: || 
...
| **var.auto_pause** | block | False | -  |  -  |  An `auto_pause` block. | | `auto_pause` block structure: || 
...
| **var.library_requirement** | block | False | -  |  -  |  A `library_requirement` block. | | `library_requirement` block structure: || 
...
| **var.spark_config** | block | False | -  |  -  |  A `spark_config` block. | | `spark_config` block structure: || 
