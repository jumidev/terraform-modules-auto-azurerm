...
| ---- | ---- | --------- | --------- |
| **upns** | list | No  | A list of User Principal Names identified by the Certificate. In addition to the Arguments listed above - the following Attributes are exported: | 
