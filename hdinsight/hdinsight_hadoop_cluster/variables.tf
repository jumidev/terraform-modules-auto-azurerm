...
#   days (number)                 : (REQUIRED) The days of the week to perform autoscale. Possible values are 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday' and 'Sunday'.
...
#   compute_isolation_enabled (bool) : This field indicates whether enable compute isolation or not. Possible values are 'true' or 'false'.
