...
| `edge_node` | [block](#roles-block-structure) | No | - | A 'edge_node' block. |
...
| `install_script_action` | [block](#edge_node-block-structure) | Yes | - | A 'install_script_action' block. |
| `https_endpoints` | [block](#edge_node-block-structure) | No | - | The HTTPS Connectivity Endpoint for this HDInsight Hadoop Cluster. One or more 'https_endpoints' blocks. |
| `uninstall_script_actions` | [block](#edge_node-block-structure) | No | - | A 'uninstall_script_actions' block. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `capacity` | [block](#autoscale-block-structure) | No | - | A 'capacity' block. |
