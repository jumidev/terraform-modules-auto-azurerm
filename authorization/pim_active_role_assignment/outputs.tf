...
output "role_definition_id" {
  value = azurerm_pim_active_role_assignment.this.role_definition_id
}

output "scope" {
  value = azurerm_pim_active_role_assignment.this.scope
}

output "justification" {
  value = azurerm_pim_active_role_assignment.this.justification
}

output "schedule" {
  value = azurerm_pim_active_role_assignment.this.schedule
}
...
output "principal_type" {
  ...
  value       = azurerm_pim_active_role_assignment.this.principal_type
}
