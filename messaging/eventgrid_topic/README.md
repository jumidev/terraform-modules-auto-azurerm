...
inputs = {
   name = "Specifies the name of the EventGrid Topic resource"   
...
| `identity_ids` | list | No | - | Specifies a list of User Assigned Managed Identity IDs to be assigned to this Event Grid Topic. |
