...
output "namespace_name" {
  value = azurerm_eventhub_namespace_authorization_rule.this.namespace_name
}

output "resource_group_name" {
  value = azurerm_eventhub_namespace_authorization_rule.this.resource_group_name
}

output "listen" {
  value = azurerm_eventhub_namespace_authorization_rule.this.listen
}

output "send" {
  value = azurerm_eventhub_namespace_authorization_rule.this.send
}

output "manage" {
  value = azurerm_eventhub_namespace_authorization_rule.this.manage
}
