...
inputs = {
   name = "Specifies the name of the EventGrid Event Subscription resource..."   
   scope = "Specifies the scope at which the EventGrid Event Subscription should be created..."   
}
...
| ---- | --------- |  ----------- |
| **name** | string |  Specifies the name of the EventGrid Event Subscription resource. Changing this forces a new resource to be created. | 
| **scope** | string |  Specifies the scope at which the EventGrid Event Subscription should be created. Changing this forces a new resource to be created. | 

## Optional Variables

| Name | Type |  Default  |  possible values |  Description |
| ---- | --------- |  ----------- | ----------- | ----------- |
| **expiration_time_utc** | string |  -  |  `RFC 3339`  |  Specifies the expiration time of the event subscription (Datetime Format `RFC 3339`). | 
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `max_delivery_attempts` | number | Yes | - | Specifies the maximum number of delivery retry attempts for events. |
