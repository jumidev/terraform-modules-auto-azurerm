...
resource "azurerm_eventgrid_domain" "this" {
  ...
  auto_create_topic_with_first_subscription = var.auto_create_topic_with_first_subscription # Default: True
  auto_delete_topic_with_last_subscription  = var.auto_delete_topic_with_last_subscription  # Default: True
