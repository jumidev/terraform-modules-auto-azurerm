...
variable "web_pubsub_id" {
  description = "(REQUIRED) The ID of the Web Pubsub service. Changing this forces a new resource to be created."
  type        = string
...
variable "default_action" {
  description = "The default action to control the network access when no other rule matches. Possible values are 'Allow' and 'Deny'. Defaults to 'Deny'."
  type        = string
  default     = "Deny"
}
