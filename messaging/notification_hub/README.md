...
| **var.apns_credential** | block | False | A `apns_credential` block. | | `apns_credential` block structure: || 
...
| **var.gcm_credential** | block | False | A `gcm_credential` block. | | `gcm_credential` block structure: || 
