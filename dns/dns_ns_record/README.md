...
| ---- | ---- | --------- | -------- | ----------- | ----------- |
| **name** | string | True | -  |  -  | The name of the DNS NS Record. Changing this forces a new resource to be created. | 
...
| **records** | list | True | -  |  -  | A list of values that make up the NS record. | 
