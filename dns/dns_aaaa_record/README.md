...
| ---- | ---- | --------- |  ----------- |
| **var.name** | string | True | The name of the DNS AAAA Record. Changing this forces a new resource to be created. | 
...
| **var.records** | string | False | List of IPv6 Addresses. Conflicts with `target_resource_id`. | 
