...
| ---- | --------- |  ----------- |
| **var.name** | string |  The name of the DNS AAAA Record. Changing this forces a new resource to be created. | 
...
| Name | Type |  Description |
| ---- | --------- |  ----------- |
| **var.records** | string |  List of IPv6 Addresses. Conflicts with `target_resource_id`. | 
