...
output "resource_group_name" {
  value = azurerm_dns_a_record.this.resource_group_name
}

output "zone_name" {
  value = azurerm_dns_a_record.this.zone_name
}

output "ttl" {
  value = azurerm_dns_a_record.this.ttl
}

output "records" {
  value = azurerm_dns_a_record.this.records
}

output "target_resource_id" {
  value = azurerm_dns_a_record.this.target_resource_id
}
