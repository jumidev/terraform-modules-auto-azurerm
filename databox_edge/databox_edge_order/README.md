...
| **var.contact** | block | True | A `contact` block. | | `contact` block structure: || 
...
| **var.shipment_address** | block | True | A `shipment_address` block. | | `shipment_address` block structure: || 
