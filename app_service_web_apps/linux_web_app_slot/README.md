...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `action` | [block](#auto_heal_setting-block-structure) | No | - | A 'action' block. |
| `trigger` | [block](#auto_heal_setting-block-structure) | No | - | A 'trigger' block. |
...
| `schedule` | [block](#backup-block-structure) | Yes | - | An 'schedule' block. |
...
| `worker_count` | int | No | - | The number of Workers for this Linux App Service Slot. |
