...
#   api_definition_url (string)                           : The URL to the API Definition for this Linux Web App.
#   api_management_api_id (string)                        : The API Management API ID this Linux Web App is associated with.
...
#   default_documents (list)                              : Specifies a list of Default Documents for the Linux Web App.
...
#   managed_pipeline_mode (string)                        : Managed pipeline mode. Possible values include 'Integrated', and 'Classic'. Defaults to 'Integrated'.
...
#   worker_count (number)                                 : The number of Workers for this Linux App Service.
#
...
#   type (string)           : (REQUIRED) Specifies the type of Managed Service Identity that should be configured on this Linux Web App. Possible values are 'SystemAssigned', 'UserAssigned', and 'SystemAssigned, UserAssigned' (to enable both).
#   identity_ids (list)     : A list of User Assigned Managed Identity IDs to be assigned to this Linux Web App.
...
#   app_setting_names (list)       : A list of 'app_setting' names that the Linux Web App will not swap between Slots when a swap operation is triggered.
#   connection_string_names (list) : A list of 'connection_string' names that the Linux Web App will not swap between Slots when a swap operation is triggered.
