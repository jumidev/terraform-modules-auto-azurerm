...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `azure_blob_storage` | block | No | - | A 'azure_blob_storage_http' block. |
| `file_system` | block | No | - | A 'file_system' block. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `requests` | block | No | - | A 'requests' block. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `azure_blob_storage` | block | No | - | An 'azure_blob_storage' block. |
