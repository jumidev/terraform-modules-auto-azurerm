...
inputs = {
   location = "${location}" 
   name = "name of linux_web_app" 
   resource_group_name = "${resource_group}" 
   service_plan_id = "service_plan_id of linux_web_app" 
   site_config = {
      example_site_config = {
...
| ---- | --------- |  ----------- |
| **var.location** | string |  The Azure Region where the Linux Web App should exist. Changing this forces a new Linux Web App to be created. | 
| **var.name** | string |  The name which should be used for this Linux Web App. Changing this forces a new Linux Web App to be created. | 
| **var.resource_group_name** | string |  The name of the Resource Group where the Linux Web App should exist. Changing this forces a new Linux Web App to be created. | 
| **var.service_plan_id** | string |  The ID of the Service Plan that this Linux App Service will be created in. | 
...
| **var.client_certificate_mode** | string |  `Required`  |  `Required`, `Optional`, `OptionalInteractiveUser`  |  The Client Certificate mode. Possible values are `Required`, `Optional`, and `OptionalInteractiveUser`. This property has no effect when `client_certificate_enabled` is `false`. Defaults to `Required`. | 
...
| **var.tags** | map |  -  |  -  |  A mapping of tags which should be assigned to the Linux Web App. | 
...
| `worker_count` | int | No | - | The number of Workers for this Linux App Service. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `retention_in_days` | int | Yes | - | The retention period in days. A value of '0' means no retention. |
