...
inputs = {
   name = "The name which should be used for this Windows Web App Slot..."   
...
| ---- | --------- |  ----------- |
| **name** | string |  The name which should be used for this Windows Web App Slot. Changing this forces a new Windows Web App Slot to be created. | 
| **app_service_id** | string |  The ID of the Windows Web App this Deployment Slot will be part of. Changing this forces a new Windows Web App to be created. | 
...
| **enabled** | bool |  `True`  |  -  |  Should the Windows Web App Slot be enabled? Defaults to `true`. | 
...
| **https_only** | string |  -  |  -  |  Should the Windows Web App Slot require HTTPS connections. | 
...
| **service_plan_id** | string |  -  |  -  |  The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Windows Web App will be used. | 
| **storage_account** | [block](#storage_account-block-structure) |  -  |  -  |  One or more `storage_account` blocks. | 
| **tags** | map |  -  |  -  |  A mapping of tags which should be assigned to the Windows Web App Slot. | 
| **virtual_network_subnet_id** | string |  -  |  -  |  The subnet id which will be used by this Web App Slot for [regional virtual network integration](https://docs.microsoft.com/en-us/azure/app-service/overview-vnet-integration#regional-virtual-network-integration). | 
...
| `oauth_scopes` | list | No | - | Specifies a list of OAuth 2.0 scopes that will be requested as part of GitHub login authentication. |
...
| `default_documents` | list | No | - | Specifies a list of Default Documents for the Windows Web App Slot. |
...
| `ip_restriction` | string | No | - | One or more 'ip_restriction' blocks. |
...
| `scm_ip_restriction` | string | No | - | One or more 'scm_ip_restriction' blocks. |
...
| `worker_count` | number | No | - | The number of Workers for this Windows App Service Slot. |
...
| `slow_request` | string | No | - | One or more 'slow_request' blocks. |
| `status_code` | string | No | - | One or more 'status_code' blocks. |
...
| `tomcat_version` | string | No | - | The version of Tomcat the Java App should use. |
| `java_embedded_server_enabled` | bool | No | - | Should the Java Embedded Server (Java SE) be used to run the app. |
| `java_version` | string | No | - | The version of Java to use when 'current_stack' is set to 'java'. Possible values include '1.7', '1.8', '11' and '17'. Required with 'java_container' and 'java_container_version'. |
| `node_version` | string | No | - | The version of node to use when 'current_stack' is set to 'node'. Possible values include '~12', '~14', '~16', and '~18'. |
| `php_version` | string | No | - | The version of PHP to use when 'current_stack' is set to 'php'. Possible values are '7.1', '7.4' and 'Off'. |
| `python` | bool | No | False | The app is a Python app. Defaults to 'false'. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `action_type` | string | Yes | - | Predefined action to be taken to an Auto Heal trigger. Possible values are 'CustomAction', 'LogEvent' and 'Recycle'. |
| `custom_action` | [block](#custom_action-block-structure) | No | - | A 'custom_action' block. |
| `minimum_process_execution_time` | string | No | - | The minimum amount of time in 'hh:mm:ss' the Windows Web App Slot must have been running before the defined action will be run in the event of a trigger. |
