...
| `virtual_directory` | block | No | - | One or more 'virtual_directory' blocks. |
...
| `custom_action` | block | No | - | A 'custom_action' block. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `action` | block | Yes | - | A 'action' block. |
| `trigger` | block | Yes | - | A 'trigger' block. |
