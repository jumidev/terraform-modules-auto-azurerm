...
| **id** | string  | The ID of the Windows Web App Slot. | 
...
| **default_hostname** | string  | The default hostname of the Windows Web App Slot. | 
| **identity** | block  | An `identity` block. | 
| **kind** | string  | The Kind value for this Windows Web App Slot. | 
