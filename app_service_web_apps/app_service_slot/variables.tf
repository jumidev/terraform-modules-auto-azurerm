...
variable "resource_group_name" {
  description = "(REQUIRED) The name of the resource group in which to create the App Service Slot component. Changing this forces a new resource to be created."
  type        = string
...
variable "enabled" {
  description = "Is the App Service Slot Enabled? Defaults to 'true'."
  type        = bool
  default     = true
}
variable "https_only" {
...
#   dotnet_framework_version (string)            : The version of the .NET framework's CLR used in this App Service Slot. Possible values are 'v2.0' (which will use the latest version of the .NET framework for the .NET CLR v2 - currently '.net 3.5'), 'v4.0' (which corresponds to the latest version of the .NET CLR v4 - which at the time of writing is '.net 4.7.1'), 'v5.0' and 'v6.0'. [For more information on which .NET CLR version to use based on the .NET framework you're targeting - please see this table](https://en.wikipedia.org/wiki/.NET_Framework_version_history#Overview). Defaults to 'v4.0'.
#   ftps_state (string)                          : State of FTP / FTPS service for this App Service Slot. Possible values include: 'AllAllowed', 'FtpsOnly' and 'Disabled'.
#   health_check_path (string)                   : The health check path to be pinged by App Service Slot. [For more information - please see App Service health check announcement](https://azure.github.io/AppService/2020/08/24/healthcheck-on-app-service.html).
#   number_of_workers (number)                   : The scaled number of workers (for per site scaling) of this App Service Slot. Requires that 'per_site_scaling' is enabled on the 'azurerm_app_service_plan'. [For more information - please see Microsoft documentation on high-density hosting](https://docs.microsoft.com/azure/app-service/manage-scale-per-app).
...
#   linux_fx_version (string)                    : Linux App Framework and version for the App Service Slot. Possible options are a Docker container ('DOCKER|<user/image:tag>'), a base-64 encoded Docker Compose file ('COMPOSE|${filebase64('compose.yml')}') or a base-64 encoded Kubernetes Manifest ('KUBE|${filebase64('kubernetes.yml')}').
...
#   php_version (string)                         : The version of PHP to use in this App Service Slot. Possible values are '5.5', '5.6', '7.0', '7.1', '7.2', '7.3', and '7.4'.
#   python_version (string)                      : The version of Python to use in this App Service Slot. Possible values are '2.7' and '3.4'.
...
#   scm_type (string)                            : The type of Source Control enabled for this App Service Slot. Defaults to 'None'. Possible values are: 'BitbucketGit', 'BitbucketHg', 'CodePlexGit', 'CodePlexHg', 'Dropbox', 'ExternalGit', 'ExternalHg', 'GitHub', 'LocalGit', 'None', 'OneDrive', 'Tfs', 'VSO', and 'VSTSRM'
...
variable "app_service_resource_group_name" {
  description = "The Name of the Resource Group where the App Service exists..  If not specified, value of var.resource_group_name will be used."
  type        = string
  default     = null
}
