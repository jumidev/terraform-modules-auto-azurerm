...
#   number_of_workers (int)                      : The scaled number of workers (for per site scaling) of this App Service Slot. Requires that 'per_site_scaling' is enabled on the 'azurerm_app_service_plan'. [For more information - please see Microsoft documentation on high-density hosting](https://docs.microsoft.com/azure/app-service/manage-scale-per-app).
