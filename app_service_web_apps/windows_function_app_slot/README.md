...
| ---- | --------- |  ----------- |
| **var.name** | string |  Specifies the name of the Windows Function App Slot. Changing this forces a new resource to be created. | 
| **var.function_app_id** | string |  The name of the Windows Function App this Slot is a member of. Changing this forces a new resource to be created. | 
...
| **var.enabled** | bool |  `True`  |  -  |  Is the Windows Function App Slot enabled. Defaults to `true`. | 
...
| **var.service_plan_id** | string |  -  |  -  |  The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Windows Function App will be used. | 
...
| **var.storage_key_vault_secret_id** | string |  -  |  -  |  The Key Vault Secret ID, optionally including version, that contains the Connection String to connect to the storage account for this Function App Slot. | 
| **var.tags** | map |  -  |  -  |  A mapping of tags which should be assigned to the Windows Function App Slot. | 
...
| `headers` | block | No | - | a 'headers' block as detailed below. |
