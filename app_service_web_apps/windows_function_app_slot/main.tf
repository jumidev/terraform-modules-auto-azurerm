...
resource "azurerm_windows_function_app_slot" "this" {
  ...
  site_config {
    ...
    health_check_eviction_time_in_min      = lookup(site_config.value, "health_check_eviction_time_in_min", "0")
  ...
  dynamic "storage_account" { # var.storage_account
    ...
    content {
      ...
      type         = lookup(storage_account.value, "type")       # (Required) possible values: AzureFiles
