...
variable "name" {
  description = "(REQUIRED) Specifies the name of the Windows Function App Slot. Changing this forces a new resource to be created."
  type        = string

}
variable "function_app_id" {
  description = "(REQUIRED) The name of the Windows Function App this Slot is a member of. Changing this forces a new resource to be created."
  type        = string
...
#   default_documents (list)                       : Specifies a list of Default Documents for the Windows Web App.
...
#   pre_warmed_instance_count (number)             : The number of pre-warmed instances for this function app. Only affects apps on an Elastic Premium plan.
...
#   scm_type (string)                              : The SCM Type in use by the Windows Function App.
...
#   x_azure_fdid (list)       : Specifies a list of Azure Front Door IDs.
#   x_fd_health_probe (string): Specifies if a Front Door Health Probe should be expected. The only possible value is '1'.
#   x_forwarded_for (list)    : Specifies a list of addresses for which matching should be applied. Omitting this value means allow any.
#   x_forwarded_host (list)   : Specifies a list of Hosts for which matching should be applied.
#
...
#   java_version (string)             : The version of Java to use. Possible values are '1.8', '11' and '17' (In-Preview).
#   node_version (string)             : The version of Node to use. Possible values are '~12', '~14', '~16' and '~18'.
