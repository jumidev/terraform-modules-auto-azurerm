...
inputs = {
   name = "Specifies the name of the Function App Slot"   
...
| `default_documents` | list | No | - | Specifies a list of Default Documents for the Linux Web App. |
| `detailed_error_logging_enabled` | bool | No | - | Is detailed error logging enabled |
| `elastic_instance_minimum` | number | No | - | The number of minimum instances for this Linux Function App. Only affects apps on Elastic Premium plans. |
...
| `worker_count` | number | No | - | The number of Workers for this Linux Function App. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `docker` | [block](#docker-block-structure) | No | - | a 'docker' block as detailed below. |
