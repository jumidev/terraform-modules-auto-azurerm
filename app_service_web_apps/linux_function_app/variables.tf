...
#   elastic_instance_minimum (number)                     : The number of minimum instances for this Linux Function App. Only affects apps on Elastic Premium plans.
...
#   worker_count (number)                                 : The number of Workers for this Linux Function App.
#
...
#   docker (block)                    : One or more 'docker' blocks.
#   dotnet_version (string)           : The version of .NET to use. Possible values include '3.1', '6.0', '7.0' and '8.0'.
#   use_dotnet_isolated_runtime (bool): Should the DotNet process use an isolated runtime. Defaults to 'false'.
#   java_version (string)             : The Version of Java to use. Supported versions include '8', '11' & '17'.
#   node_version (string)             : The version of Node to run. Possible values include '12', '14', '16' and '18'.
#   python_version (string)           : The version of Python to run. Possible values are '3.11', '3.10', '3.9', '3.8' and '3.7'.
