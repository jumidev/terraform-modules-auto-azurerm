...
resource "azurerm_windows_web_app" "this" {
  ...
  site_config {
    ...
    auto_heal_setting                             = lookup(site_config.value, "auto_heal_setting", null)
    ...
    virtual_application                           = lookup(site_config.value, "virtual_application", null)
  ...
  client_certificate_mode            = var.client_certificate_mode # Default: Required
    ...
    content {
      ...
      dynamic "application_logs" { # logs.value.application_logs
        ...
        content {
          ...
          file_system_level = lookup(application_logs.value, "file_system_level") # (Required) possible values: Verbose | Information | Warning | Error
        }
      }
