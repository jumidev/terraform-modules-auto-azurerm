...
| ---- | --------- |  ----------- |
| **var.location** | string |  The Azure Region where the Windows Web App should exist. Changing this forces a new Windows Web App to be created. | 
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `action` | [block](#auto_heal_setting-block-structure) | Yes | - | An 'action' block. |
...
| `http_logs` | [block](#logs-block-structure) | No | - | A 'http_logs' block. |
