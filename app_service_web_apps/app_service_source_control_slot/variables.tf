...
variable "slot_id" {
  description = "(REQUIRED) The ID of the Linux or Windows Web App Slot. Changing this forces a new resource to be created."
  type        = string
...
variable "github_action_configuration" {
  description = "A 'github_action_configuration' block as detailed below. Changing this forces a new resource to be created."
  type        = map(any)
  default     = null
}
#
...
#   runtime_stack (string)            : (REQUIRED) The value to use for the Runtime Stack in the workflow file content for code base apps. Changing this forces a new resource to be created. Possible values are 'dotnetcore', 'spring', 'tomcat', 'node' and 'python'.
...
variable "use_local_git" {
  description = "Should the Slot use local Git configuration. Changing this forces a new resource to be created."
  type        = bool
  default     = null
}
variable "use_manual_integration" {
  description = "Should code be deployed manually. Set to 'true' to disable continuous integration, such as webhooks into online repos such as GitHub. Defaults to 'false'. Changing this forces a new resource to be created."
  type        = bool
  default     = false
}
