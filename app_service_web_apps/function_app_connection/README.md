...
| ---- | --------- |  ----------- |
| **var.name** | string  The name of the service connection. Changing this forces a new resource to be created. | 
| **var.function_app_id** | string  The ID of the data source function app. Changing this forces a new resource to be created. | 
...
| **var.authentication** | block  The authentication info. An `authentication` block. | 
