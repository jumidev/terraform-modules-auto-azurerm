output "location" {
  value = azurerm_windows_function_app.this.location
}
...
output "resource_group_name" {
  value = azurerm_windows_function_app.this.resource_group_name
}

output "service_plan_id" {
  value = azurerm_windows_function_app.this.service_plan_id
}

output "site_config" {
  value = azurerm_windows_function_app.this.site_config
}

output "app_settings" {
  value = azurerm_windows_function_app.this.app_settings
}

output "auth_settings" {
  value = azurerm_windows_function_app.this.auth_settings
}

output "auth_settings_v2" {
  value = azurerm_windows_function_app.this.auth_settings_v2
}

output "backup" {
  value = azurerm_windows_function_app.this.backup
}

output "builtin_logging_enabled" {
  value = azurerm_windows_function_app.this.builtin_logging_enabled
}

output "client_certificate_enabled" {
  value = azurerm_windows_function_app.this.client_certificate_enabled
}

output "client_certificate_mode" {
  value = azurerm_windows_function_app.this.client_certificate_mode
}

output "client_certificate_exclusion_paths" {
  value = azurerm_windows_function_app.this.client_certificate_exclusion_paths
}

output "connection_string" {
  value = azurerm_windows_function_app.this.connection_string
}

output "content_share_force_disabled" {
  value = azurerm_windows_function_app.this.content_share_force_disabled
}

output "daily_memory_time_quota" {
  value = azurerm_windows_function_app.this.daily_memory_time_quota
}

output "enabled" {
  value = azurerm_windows_function_app.this.enabled
}

output "ftp_publish_basic_authentication_enabled" {
  value = azurerm_windows_function_app.this.ftp_publish_basic_authentication_enabled
}

output "functions_extension_version" {
  value = azurerm_windows_function_app.this.functions_extension_version
}

output "https_only" {
  value = azurerm_windows_function_app.this.https_only
}

output "public_network_access_enabled" {
  value = azurerm_windows_function_app.this.public_network_access_enabled
}
...
output "key_vault_reference_identity_id" {
  value = azurerm_windows_function_app.this.key_vault_reference_identity_id
}

output "storage_account" {
  value = azurerm_windows_function_app.this.storage_account
}

output "sticky_settings" {
  value = azurerm_windows_function_app.this.sticky_settings
}

output "storage_account_access_key" {
  value     = azurerm_windows_function_app.this.storage_account_access_key
  sensitive = true
}

output "storage_account_name" {
  value = azurerm_windows_function_app.this.storage_account_name
}

output "storage_uses_managed_identity" {
  value = azurerm_windows_function_app.this.storage_uses_managed_identity
}

output "storage_key_vault_secret_id" {
  value     = azurerm_windows_function_app.this.storage_key_vault_secret_id
  sensitive = true
}

output "tags" {
  value = azurerm_windows_function_app.this.tags
}

output "virtual_network_subnet_id" {
  value = azurerm_windows_function_app.this.virtual_network_subnet_id
}

output "webdeploy_publish_basic_authentication_enabled" {
  value = azurerm_windows_function_app.this.webdeploy_publish_basic_authentication_enabled
}

output "zip_deploy_file" {
  value = azurerm_windows_function_app.this.zip_deploy_file
}
...
output "principal_id" {
  ...
  value       = azurerm_windows_function_app.this.principal_id
}

output "tenant_id" {
  description = "The Tenant ID associated with this Managed Service Identity."
  value       = azurerm_windows_function_app.this.tenant_id
}
