...
|   pre_warmed_instance_count (int): The number of pre-warmed instances for this Windows Function App. Only affects apps on an Elastic Premium plan. ||
...
| **var.auth_settings_v2** | block | False | -  |  -  |  A `auth_settings_v2` block. | | `auth_settings_v2` block structure: || 
