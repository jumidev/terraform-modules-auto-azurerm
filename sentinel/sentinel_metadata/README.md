...
| **var.author** | block | False | -  |  An `author` blocks. | | `author` block structure: || 
...
| **var.category** | block | False | -  |  A `category` block. | | `category` block structure: || 
...
| **var.dependency** | block | False | -  |  A JSON formatted `dependency` block. Dependency for the content item, what other content items it requires to work. | | `dependency` block structure: || 
...
| **var.source** | block | False | -  |  A `source` block. | | `source` block structure: || 
