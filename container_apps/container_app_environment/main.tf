...
resource "azurerm_container_app_environment" "this" {
  ...
  dynamic "workload_profile" { # var.workload_profile
    ...
    content {
      ...
      workload_profile_type = lookup(workload_profile.value, "workload_profile_type") # (Required) possible values: Consumption | D4 | D8 | D16 | D32 | E4 | E8 | E16 | E32
  ...
  mutual_tls_enabled = var.mutual_tls_enabled # Default: False
  tags               = var.tags
}
