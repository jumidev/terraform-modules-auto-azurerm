...
| **var.template** | block | True | -  |  A `template` block as detailed below. | | `template` block structure: || 
...
| **var.dapr** | block | False | -  |  A `dapr` block as detailed below. | | `dapr` block structure: || 
...
| **var.ingress** | block | False | -  |  An `ingress` block as detailed below. | | `ingress` block structure: || 
...
| **var.registry** | block | False | -  |  A `registry` block as detailed below. | | `registry` block structure: || 
