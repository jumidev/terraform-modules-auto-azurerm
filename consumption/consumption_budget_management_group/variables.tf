...
variable "name" {
  description = "(REQUIRED) The name which should be used for this Management Group Consumption Budget. Changing this forces a new resource to be created."
  type        = string

}
variable "management_group_id" {
  description = "(REQUIRED) The ID of the Management Group. Changing this forces a new resource to be created."
  type        = string
