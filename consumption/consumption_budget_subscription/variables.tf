...
variable "name" {
  description = "(REQUIRED) The name which should be used for this Subscription Consumption Budget. Changing this forces a new resource to be created."
  type        = string

}
variable "subscription_id" {
  description = "(REQUIRED) The ID of the Subscription for which to create a Consumption Budget. Changing this forces a new resource to be created."
  type        = string
