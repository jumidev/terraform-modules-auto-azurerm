...
inputs = {
   ...
   account_name = "The name of the Cosmos DB Account to create the container within..."   
   database_name = "The name of the Cosmos DB SQL Database to create the container within..."   
