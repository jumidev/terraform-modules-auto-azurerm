...
#   maximum (number)        : (REQUIRED) The maximum number of instances for this resource. Valid values are between '0' and '1000'.
#   minimum (number)        : (REQUIRED) The minimum number of instances for this resource. Valid values are between '0' and '1000'.
#
...
#   timezone (list)           : The Time Zone of the 'start' and 'end' times. A list of [possible values can be found here](https://msdn.microsoft.com/en-us/library/azure/dn931928.aspx). Defaults to 'UTC'.
#
# recurrence block structure:
#   timezone (list)           : The Time Zone used for the 'hours' field. A list of [possible values can be found here](https://msdn.microsoft.com/en-us/library/azure/dn931928.aspx). Defaults to 'UTC'.
#   days (number)             : (REQUIRED) A list of days that this profile takes effect on. Possible values include 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday' and 'Sunday'.
...
#   minutes (number)          : (REQUIRED) A list containing a single item which specifies the Minute interval at which this recurrence should be triggered.
...
#   custom_emails (list)                        : Specifies a list of custom email addresses to which the email notifications will be sent.
#
