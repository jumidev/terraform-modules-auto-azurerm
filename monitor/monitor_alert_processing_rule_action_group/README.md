...
inputs = {
   add_action_group_ids = "Specifies a list of Action Group IDs"   
...
| ---- | --------- |  ----------- |
| **add_action_group_ids** | list |  Specifies a list of Action Group IDs. | 
...
| `values` | list | Yes | - | Specifies a list of values to match for a given condition. Possible values are 'Fired' and 'Resolved'. |

### `recurrence` block structure

| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `daily` | string | No | - | One or more 'daily' blocks. |
| `weekly` | [block](#weekly-block-structure) | No | - | One or more 'weekly' blocks. |
| `monthly` | string | No | - | One or more 'monthly' blocks. |
...
| `values` | list | Yes | - | Specifies a list of values to match for a given condition. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `days_of_week` | number | Yes | - | Specifies a list of dayOfWeek to recurrence. Possible values are 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', and 'Saturday'. |
...
| ---- | ---- | --------- | ------- | ----------- |
| `operator` | string | Yes | - | The operator for a given condition. Possible values are 'Equals' and 'NotEquals'. |
| `values` | list | Yes | - | Specifies a list of values to match for a given condition. Possible values are 'Metric', 'Log', 'Unknown', and 'Health'. |
