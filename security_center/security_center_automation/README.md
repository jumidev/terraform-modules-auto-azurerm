...
inputs = {
   location = "${location}"   
   name = "The name which should be used for this Security Center Automation..."   
   resource_group_name = "${resource_group}"   
   scopes = "A list of scopes on which the automation logic is applied, at least one is requi..."   
   source = {
      this_source = {
         event_source = "Possible values: Alerts | Assessments | AssessmentsSnapshot | RegulatoryComplianceAssessment | RegulatoryComplianceAssessmentSnapshot | SecureScoreControls | SecureScoreControlsSnapshot | SecureScores | SecureScoresSnapshot | SubAssessments | SubAssessmentsSnapshot"         
      }
