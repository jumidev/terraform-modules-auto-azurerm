...
| **var.custom_persistent_disk** | block | False | -  |  A `custom_persistent_disk` block. | | `custom_persistent_disk` block structure: || 
...
| **var.ingress_settings** | block | False | -  |  An `ingress_settings` block. | | `ingress_settings` block structure: || 
...
| **var.persistent_disk** | block | False | -  |  An `persistent_disk` block. | | `persistent_disk` block structure: || 
