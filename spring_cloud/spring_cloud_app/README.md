...
| `read_timeout_in_seconds` | number | No | 300 | Specifies the ingress read time out in seconds. Defaults to '300'. |
| `send_timeout_in_seconds` | number | No | 60 | Specifies the ingress send time out in seconds. Defaults to '60'. |
...
| Name | Type | Required? | Default | Description |
| ---- | ---- | --------- | ------- | ----------- |
| `size_in_gb` | number | Yes | - | Specifies the size of the persistent disk in GB. Possible values are between '0' and '50'. |
