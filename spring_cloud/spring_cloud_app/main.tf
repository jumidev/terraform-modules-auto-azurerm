...
resource "azurerm_spring_cloud_app_cosmosdb_association" "this" {
  ...
  name                             = lookup(var.spring_cloud_app_cosmosdb_association, "var.name", null)
  spring_cloud_app_id              = azurerm_spring_cloud_app.this.id
  cosmosdb_account_id              = lookup(var.spring_cloud_app_cosmosdb_association, "var.cosmosdb_account_id", null)
  api_type                         = lookup(var.spring_cloud_app_cosmosdb_association, "var.api_type", null)
  cosmosdb_access_key              = lookup(var.spring_cloud_app_cosmosdb_association, "var.cosmosdb_access_key", null)
...
resource "azurerm_spring_cloud_app_redis_association" "this" {
  ...
  name                = lookup(var.spring_cloud_app_redis_association, "var.name", null)
  spring_cloud_app_id = azurerm_spring_cloud_app.this.id
  redis_cache_id      = lookup(var.spring_cloud_app_redis_association, "var.redis_cache_id", null)
  redis_access_key    = lookup(var.spring_cloud_app_redis_association, "var.redis_access_key", null)
...
resource "azurerm_spring_cloud_app_mysql_association" "this" {
  ...
  name                = lookup(var.spring_cloud_app_mysql_association, "var.name", null)
  spring_cloud_app_id = azurerm_spring_cloud_app.this.id
  mysql_server_id     = lookup(var.spring_cloud_app_mysql_association, "var.mysql_server_id", null)
  database_name       = lookup(var.spring_cloud_app_mysql_association, "var.database_name", null)
  username            = lookup(var.spring_cloud_app_mysql_association, "var.username", null)
  password            = lookup(var.spring_cloud_app_mysql_association, "var.password", null)
}
