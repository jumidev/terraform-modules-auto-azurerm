...
| **var.build_pack_group** | block | True | One or more `build_pack_group` blocks. | | `build_pack_group` block structure: || 
...
| **var.stack** | block | True | A `stack` block. | | `stack` block structure: || 
