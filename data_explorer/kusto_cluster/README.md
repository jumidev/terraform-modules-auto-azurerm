...
| **var.virtual_network_configuration** | block | False | -  |  -  |  A `virtual_network_configuration` block. Changing this forces a new resource to be created. | | `virtual_network_configuration` block structure: || 
...
| **var.optimized_auto_scale** | block | False | -  |  -  |  An `optimized_auto_scale` block. | | `optimized_auto_scale` block structure: || 
