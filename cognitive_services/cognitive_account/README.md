...
inputs = {
   name = "Specifies the name of the Cognitive Service Account..."   
   resource_group_name = "${resource_group}"   
   location = "${location}"   
   kind = "Specifies the type of Cognitive Service Account that should be created..."   
   sku_name = "Specifies the SKU Name for this Cognitive Service Account..."   
}
...
| `ip_rules` | string | No | - | One or more IP Addresses, or CIDR Blocks which should be able to access the Cognitive Account. |
...
| `identity_ids` | list | No | - | Specifies a list of User Assigned Managed Identity IDs to be assigned to this Cognitive Account. |
