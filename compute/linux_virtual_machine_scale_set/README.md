...
| ---- | --------- |  ----------- | ----------- | ----------- |
| **instances** | number |  `0`  |  -  |  The number of Virtual Machines in the Scale Set. Defaults to `0`. | 
...
| **zones** | list |  -  |  -  |  Specifies a list of Availability Zones in which this Linux Virtual Machine Scale Set should be located. Changing this forces a new Linux Virtual Machine Scale Set to be created. | 
...
| `identity_ids` | list | No | - | Specifies a list of User Assigned Managed Identity IDs to be assigned to this Linux Virtual Machine Scale Set. |
