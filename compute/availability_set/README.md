...
| ---- | --------- |  ----------- | ----------- | ----------- |
| **platform_update_domain_count** | number |  `5`  |  -  |  Specifies the number of update domains that are used. Defaults to `5`. Changing this forces a new resource to be created. | 
| **platform_fault_domain_count** | number |  `3`  |  -  |  Specifies the number of fault domains that are used. Defaults to `3`. Changing this forces a new resource to be created. | 
