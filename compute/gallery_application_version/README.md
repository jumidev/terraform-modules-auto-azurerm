...
inputs = {
   ...
   # gallery_application_id → set in component_inputs
   location = "${location}"   
   manage_action = {
      install = "..."      
      remove = "..."      
...
| `regional_replica_count` | number | Yes | - | The number of replicas of the Gallery Application Version to be created per region. Possible values are between '1' and '10'. |
