...
| **max_recommended_vcpu_count** | number |  -  |  -  |  Maximum count of vCPUs recommended for the Image. | 
| **min_recommended_vcpu_count** | number |  -  |  -  |  Minimum count of vCPUs recommended for the Image. | 
| **max_recommended_memory_in_gb** | number |  -  |  -  |  Maximum memory in GB recommended for the Image. | 
| **min_recommended_memory_in_gb** | number |  -  |  -  |  Minimum memory in GB recommended for the Image. | 
...
| ---- | ---- | --------- | --------- |
| **product** | string | No  | The Purchase Plan Product for this Gallery Image. Changing this forces a new resource to be created. In addition to the Arguments listed above - the following Attributes are exported: | 
