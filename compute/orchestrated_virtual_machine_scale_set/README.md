...
| **var.os_profile** | block |  -  |  -  |  An `os_profile` block. | 
| **var.os_disk** | block |  -  |  -  |  An `os_disk` block. | 
| **var.automatic_instance_repair** | block |  -  |  -  |  An `automatic_instance_repair` block. | 
...
| **var.priority_mix** | block |  -  |  -  |  a `priority_mix` block | 
