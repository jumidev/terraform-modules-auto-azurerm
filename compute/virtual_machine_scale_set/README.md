...
inputs = {
   name = "Specifies the name of the virtual machine scale set resource..."   
...
| ---- | --------- |  ----------- | ----------- |
| **name** | string |  -  |  Specifies the name of the virtual machine scale set resource. Changing this forces a new resource to be created. | 
| **resource_group_name** | string |  -  |  The name of the resource group in which to create the virtual machine scale set. Changing this forces a new resource to be created. | 
| **location** | string |  -  |  Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created. | 
| **network_profile** | [block](#network_profile-block-structure) |  -  |  A collection of `network_profile` blocks. | 
| **os_profile** | [block](#os_profile-block-structure) |  -  |  A `os_profile` block. | 
| **sku** | [block](#sku-block-structure) |  -  |  A `sku` block. | 
| **storage_profile_os_disk** | [block](#storage_profile_os_disk-block-structure) |  -  |  A `storage_profile_os_disk` block. | 
| **upgrade_policy_mode** | string |  `Rolling`, `Manual`, `Automatic`  |  Specifies the mode of an upgrade to virtual machines in the scale set. Possible values, `Rolling`, `Manual`, or `Automatic`. When choosing `Rolling`, you will need to set a health probe. | 

## Optional Variables

| Name | Type |  Default  |  possible values |  Description |
| ---- | --------- |  ----------- | ----------- | ----------- |
| **os_profile_windows_config** | [block](#os_profile_windows_config-block-structure) |  -  |  -  |  A `os_profile_windows_config` block. | 
| **os_profile_linux_config** | [block](#os_profile_linux_config-block-structure) |  -  |  -  |  A `os_profile_linux_config` block. | 
...
| **automatic_os_upgrade** | bool |  `False`  |  `upgrade_policy_mode`, `Rolling`  |  Automatic OS patches can be applied by Azure to your scaleset. This is particularly useful when `upgrade_policy_mode` is set to `Rolling`. Defaults to `false`. | 
...
| `load_balancer_inbound_nat_rules_ids` | string | No | - | Specifies an array of references to inbound NAT pools for load balancers. A scale set can reference inbound NAT pools of one public and one internal load balancer. Multiple scale sets cannot use the same load balancer. |
...
| `ssh_keys` | [block](#ssh_keys-block-structure) | No | - | One or more 'ssh_keys' blocks. |
...
| `capacity` | number | Yes | - | Specifies the number of virtual machines in the scale set. |
...
| `identity_ids` | list | No | - | Specifies a list of user managed identity ids to be assigned to the VMSS. Required if 'type' is 'UserAssigned'. |
...
| `winrm` | [block](#winrm-block-structure) | No | - | A collection of 'winrm' blocks. |
| `additional_unattend_config` | [block](#additional_unattend_config-block-structure) | No | - | An 'additional_unattend_config' block. |
...
| `ip_configuration` | [block](#ip_configuration-block-structure) | Yes | - | An 'ip_configuration' block. |
| `accelerated_networking` | string | No | - | Specifies whether to enable accelerated networking or not. |
| `dns_settings` | [block](#dns_settings-block-structure) | No | - | A 'dns_settings' block. |
