...
inputs = {
   ...
   vm_size = "Specifies the [size of the Virtual Machine](https://docs..."   
   storage_os_disk = {
      name = "..."      
      create_option = "..."      
      # managed_disk_id → (optional) set in tfstate_inputs
   }
...
tfstate_inputs = {
   ...
   storage_os_disk.managed_disk_id = "path/to/managed_disk_component:id"   
}
...
| `winrm` | [block](#winrm-block-structure) | No | - | One or more 'winrm' blocks. |
...
| `vault_certificates` | [block](#vault_certificates-block-structure) | No | - | One or more 'vault_certificates' blocks. |
...
| `ssh_keys` | [block](#ssh_keys-block-structure) | No | - | One or more 'ssh_keys' blocks. This field is required if 'disable_password_authentication' is set to 'true'. |
