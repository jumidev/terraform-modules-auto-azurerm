...
| **var.os_profile_linux_config** | block | False | -  |  -  |  (Required, when a Linux machine) An `os_profile_linux_config` block. | | `os_profile_linux_config` block structure: || 
...
| **var.os_profile_windows_config** | block | False | -  |  -  |  (Required, when a Windows machine) An `os_profile_windows_config` block. | | `os_profile_windows_config` block structure: || 
...
| **var.os_profile** | block | False | -  |  -  |  An `os_profile` block. Required when `create_option` in the `storage_os_disk` block is set to `FromImage`. | | `os_profile` block structure: || 
...
| **var.os_profile_secrets** | block | False | -  |  -  |  One or more `os_profile_secrets` blocks. | | `os_profile_secrets` block structure: || 
...
| **var.storage_data_disk** | block | False | -  |  -  |  One or more `storage_data_disk` blocks. | | `storage_data_disk` block structure: || 
...
| **var.storage_image_reference** | block | False | -  |  -  |  A `storage_image_reference` block. Changing this forces a new resource to be created. | | `storage_image_reference` block structure: || 
...
| **var.storage_os_disk** | block | True | -  |  -  |  A `storage_os_disk` block. | | `storage_os_disk` block structure: || 
