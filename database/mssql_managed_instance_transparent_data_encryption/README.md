...
| ---- | --------- |  ----------- |
| **managed_instance_id** | string |  Specifies the name of the MS SQL Managed Instance. Changing this forces a new resource to be created. | 
