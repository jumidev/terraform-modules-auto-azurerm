...
| **storage_size_in_gb** | number |  -  |  -  |  Maximum storage space for the SQL Managed instance. This should be a multiple of 32 (GB). | 
...
| **vcores** | number |  -  |  `8`, `16`, `24`, `4`, `6`, `10`, `12`, `20`, `32`, `40`, `48`, `56`, `64`, `80`, `96`, `128`  |  Number of cores that should be assigned to the SQL Managed Instance. Values can be `8`, `16`, or `24` for Gen4 SKUs, or `4`, `6`, `8`, `10`, `12`, `16`, `20`, `24`, `32`, `40`, `48`, `56`, `64`, `80`, `96` or `128` for Gen5 SKUs. | 
...
| `identity_ids` | list | No | - | Specifies a list of User Assigned Managed Identity IDs to be assigned to this SQL Managed Instance. Required when 'type' is set to 'UserAssigned'. |
