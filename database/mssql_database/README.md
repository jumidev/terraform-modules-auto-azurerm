...
| ---- | ---- | --------- |  ----------- | ----------- | ----------- |
| **var.name** | string | True | -  |  -  |  The name of the MS SQL Database. Changing this forces a new resource to be created. | 
| **var.server_id** | string | True | -  |  -  |  The id of the MS SQL Server on which to create the database. Changing this forces a new resource to be created. | 
...
| **var.import** | block | False | -  |  -  |  A `import` block. Mutually exclusive with `create_mode`. | | `import` block structure: || 
...
| **var.geo_backup_enabled** | bool | False | `True`  |  -  |  A boolean that specifies if the Geo Backup Policy is enabled. Defaults to `true`. | 
...
| **var.recover_database_id** | string | False | -  |  -  |  The ID of the database to be recovered. This property is only applicable when the `create_mode` is `Recovery`. | 
| **var.restore_dropped_database_id** | string | False | -  |  -  |  The ID of the database to be restored. This property is only applicable when the `create_mode` is `Restore`. | 
| **var.read_replica_count** | int | False | -  |  -  |  The number of readonly secondary replicas associated with the database to which readonly application intent connections may be routed. This property is only settable for Hyperscale edition databases. | 
...
| **var.short_term_retention_policy** | block | False | -  |  -  |  A `short_term_retention_policy` block. | | `short_term_retention_policy` block structure: || 
