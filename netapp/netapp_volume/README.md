...
| **var.data_protection_replication** | [block](#data_protection_replication-block-structure) |  -  |  -  |  A `data_protection_replication` block. Changing this forces a new resource to be created. | 
| **var.data_protection_snapshot_policy** | [block](#data_protection_snapshot_policy-block-structure) |  -  |  -  |  A `data_protection_snapshot_policy` block. | 
