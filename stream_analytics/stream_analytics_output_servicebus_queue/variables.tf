...
variable "queue_name" {
  description = "(REQUIRED) The name of the Service Bus Queue."
  type        = string
...
variable "property_columns" {
  description = "A list of property columns to add to the Service Bus Queue output."
  type        = list(any)
  default     = []
}
...
variable "system_property_columns" {
  description = "A key-value pair of system property columns that will be attached to the outgoing messages for the Service Bus Queue Output."
  type        = string
  default     = null
}
variable "stream_analytics_job_resource_group_name" {
  description = "Specifies the name of the resource group the Stream Analytics Job is located in..  If not specified, value of var.resource_group_name will be used..  If not specified, value of var.resource_group_name will be used."
  type        = string
  default     = null
}
variable "servicebus_queue_resource_group_name" {
  description = "The name of the Resource Group where the Service Bus Queue exists..  If not specified, value of var.resource_group_name will be used."
  type        = string
  default     = null
}
