...
| **var.topic_name** | string |  The name of the Service Bus Topic. | 
| **var.servicebus_namespace** | string |  The namespace that is associated with the desired Event Hub, Service Bus Topic, Service Bus Topic, etc. | 
...
| **var.property_columns** | list |  -  |  -  |  A list of property columns to add to the Service Bus Topic output. | 
...
| **var.system_property_columns** | string |  -  |  -  |  A key-value pair of system property columns that will be attached to the outgoing messages for the Service Bus Topic Output. | 
