...
| ---- | --------- |  ----------- |
| **name** | string |  The name of the protection container. Changing this forces a new resource to be created. | 
...
| **recovery_fabric_name** | string |  Name of fabric that should contain this protection container. Changing this forces a new resource to be created. | 
