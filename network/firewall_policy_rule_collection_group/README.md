...
| Name | Type |  Description |
| ---- | --------- |  ----------- |
| **application_rule_collections** | [block](#application_rule_collection-block-structure) |  One or more `application_rule_collection` blocks. | 
| **nat_rule_collections** | [block](#nat_rule_collection-block-structure) |  One or more `nat_rule_collection` blocks. | 
| **network_rule_collections** | [block](#network_rule_collection-block-structure) |  One or more `network_rule_collection` blocks. | 
