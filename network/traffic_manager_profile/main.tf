...
resource "azurerm_traffic_manager_profile" "this" {
  ...
  monitor_config {
    ...
    interval_in_seconds          = lookup(monitor_config.value, "interval_in_seconds", null)
    timeout_in_seconds           = lookup(monitor_config.value, "timeout_in_seconds", null)
    tolerated_number_of_failures = lookup(monitor_config.value, "tolerated_number_of_failures", null)
  }
