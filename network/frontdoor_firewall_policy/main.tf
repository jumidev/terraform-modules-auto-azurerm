  ...
  dynamic "managed_rule" { # var.managed_rule
    ...
    content {
      ...
      dynamic "exclusion" { # managed_rule.value.exclusion
        ...
        content {
          match_variable = lookup(exclusion.value, "match_variable") # (Required) possible values: QueryStringArgNames | RequestBodyPostArgNames | RequestCookieNames | RequestHeaderNames
        ...
        content {
          ...
          dynamic "rule" { # override.value.rule
            ...
            content {
              ...
              action  = lookup(rule.value, "action")  # (Required) possible values: Allow | Block | Log | Redirect
