...
| **var.retention_policy** | block | True | -  |  -  |  A `retention_policy` block. | | `retention_policy` block structure: || 
...
| **var.traffic_analytics** | block | False | -  |  -  |  A `traffic_analytics` block. | | `traffic_analytics` block structure: || 
