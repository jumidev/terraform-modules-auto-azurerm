...
| **var.storage_location** | block | True | -  |  A `storage_location` block. Changing this forces a new resource to be created. | | `storage_location` block structure: || 
...
| **var.filter** | block | False | -  |  One or more `filter` blocks. Changing this forces a new resource to be created. | | `filter` block structure: || 
...
| **var.machine_scope** | block | False | -  |  A `machine_scope` block. Changing this forces a new resource to be created. | | `machine_scope` block structure: || 
