...
| **var.backend_pool** | block | True | -  |  A `backend_pool` block. | | `backend_pool` block structure: || 
...
| **var.backend_pool_health_probe** | block | True | -  |  A `backend_pool_health_probe` block. | | `backend_pool_health_probe` block structure: || 
...
| **var.backend_pool_load_balancing** | block | True | -  |  A `backend_pool_load_balancing` block. | | `backend_pool_load_balancing` block structure: || 
...
| **var.backend_pool_settings** | block | False | -  |  A `backend_pool_settings` block. | | `backend_pool_settings` block structure: || 
...
| **var.frontend_endpoint** | block | True | -  |  A `frontend_endpoint` block. | | `frontend_endpoint` block structure: || 
...
| **var.routing_rule** | block | True | -  |  A `routing_rule` block. | | `routing_rule` block structure: || 
