...
component_inputs = {
   frontend_ip_configurations.item_1.subnet_id = "path/to/subnet_component:id"   
   frontend_ip_configurations.item_1.public_ip_address_id = "path/to/public_ip_component:id"   
   gateway_ip_configurations.item_1.subnet_id = "path/to/subnet_component:id"   
   http_listeners.item_1.frontend_ip_configuration_name = "path/to/lb_outbound_rule_component:frontend_ip_configuration"   
   http_listeners.item_1.firewall_policy_id = "path/to/firewall_policy_component:id"   
}
tfstate_store = {
