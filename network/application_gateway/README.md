...
| **var.backend_address_pool** | block | True | -  |  One or more `backend_address_pool` blocks. | | `backend_address_pool` block structure: || 
...
| **var.backend_http_settings** | block | True | -  |  One or more `backend_http_settings` blocks. | | `backend_http_settings` block structure: || 
|   name (string): (REQUIRED) The name of the Authentication Certificate. ||

| **var.frontend_ip_configuration** | block | True | -  |  One or more `frontend_ip_configuration` blocks. | | `frontend_ip_configuration` block structure: || 
...
| **var.frontend_port** | block | True | -  |  One or more `frontend_port` blocks. | | `frontend_port` block structure: || 
|   name (string): (REQUIRED) The name of the Frontend Port. ||
|   port (string): (REQUIRED) The port used for this Frontend Port. ||

| **var.gateway_ip_configuration** | block | True | -  |  One or more `gateway_ip_configuration` blocks. | | `gateway_ip_configuration` block structure: || 
...
| **var.http_listener** | block | True | -  |  One or more `http_listener` blocks. | | `http_listener` block structure: || 
...
| **var.request_routing_rule** | block | True | -  |  One or more `request_routing_rule` blocks. | | `request_routing_rule` block structure: || 
...
| **var.global** | block | False | -  |  A `global` block. | | `global` block structure: || 
...
| **var.private_link_configuration** | block | False | -  |  One or more `private_link_configuration` blocks. | | `private_link_configuration` block structure: || 
...
| **var.trusted_client_certificate** | block | False | -  |  One or more `trusted_client_certificate` blocks. | | `trusted_client_certificate` block structure: || 
...
| **var.ssl_profile** | block | False | -  |  One or more `ssl_profile` blocks. | | `ssl_profile` block structure: || 
...
| **var.authentication_certificate** | block | False | -  |  One or more `authentication_certificate` blocks. | | `authentication_certificate` block structure: || 
...
| **var.trusted_root_certificate** | block | False | -  |  One or more `trusted_root_certificate` blocks. | | `trusted_root_certificate` block structure: || 
...
| **var.ssl_policy** | block | False | -  |  a `ssl_policy` block. | | `ssl_policy` block structure: || 
...
| **var.probe** | block | False | -  |  One or more `probe` blocks. | | `probe` block structure: || 
...
| **var.ssl_certificate** | block | False | -  |  One or more `ssl_certificate` blocks. | | `ssl_certificate` block structure: || 
...
| **var.url_path_map** | block | False | -  |  One or more `url_path_map` blocks. | | `url_path_map` block structure: || 
...
| **var.waf_configuration** | block | False | -  |  A `waf_configuration` block. | | `waf_configuration` block structure: || 
...
| **var.custom_error_configuration** | block | False | -  |  One or more `custom_error_configuration` blocks. | | `custom_error_configuration` block structure: || 
...
| **var.redirect_configuration** | block | False | -  |  One or more `redirect_configuration` blocks. | | `redirect_configuration` block structure: || 
...
| **var.autoscale_configuration** | block | False | -  |  An `autoscale_configuration` block. | | `autoscale_configuration` block structure: || 
...
| **var.rewrite_rule_set** | block | False | -  |  One or more `rewrite_rule_set` blocks. Only valid for v2 SKUs. | | `rewrite_rule_set` block structure: || 
