...
tfstate_inputs = {
   frontend_ip_configuration.example_frontend_ip_configuration.subnet_id = "path/to/subnet_component:id" 
   frontend_ip_configuration.example_frontend_ip_configuration.public_ip_address_id = "path/to/public_ip_component:id" 
   gateway_ip_configuration.example_gateway_ip_configuration.subnet_id = "path/to/subnet_component:id" 
   http_listener.example_http_listener.frontend_ip_configuration_name = "path/to/lb_outbound_rule_component:frontend_ip_configuration" 
   http_listener.example_http_listener.firewall_policy_id = "path/to/firewall_policy_component:id" 
}
...
| `custom_error_configuration` | [block](#http_listener-block-structure) | No | - | One or more 'custom_error_configuration' blocks. |
