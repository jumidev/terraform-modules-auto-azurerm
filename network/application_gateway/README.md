...
inputs = {
   ...
   request_routing_rule = {
      item_1 = {
         ...
         url_path_map_name = "..."         
         priority = "Possible values: 1 | 20000 | priority | sku.0.tier | *_v2"         
      }      
      item_2 = {
         ...
      }      
...
component_inputs = {
   frontend_ip_configuration.item_1.subnet_id = "path/to/subnet_component:id"   
   frontend_ip_configuration.item_1.public_ip_address_id = "path/to/public_ip_component:id"   
   gateway_ip_configuration.item_1.subnet_id = "path/to/subnet_component:id"   
   http_listener.item_1.frontend_ip_configuration_name = "path/to/lb_outbound_rule_component:frontend_ip_configuration"   
   http_listener.item_1.firewall_policy_id = "path/to/firewall_policy_component:id"   
}
tfstate_store = {
