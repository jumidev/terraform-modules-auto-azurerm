...
| ---- | ---- | --------- | --------- |
| **public_cert_data** | string | No  | The Public Key Data associated with the Certificate. In addition to the arguments above, the following attributes are exported: | 
