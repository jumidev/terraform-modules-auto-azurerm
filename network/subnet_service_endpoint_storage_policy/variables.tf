...
#   service_resources (list)  : (REQUIRED) Specifies a list of resources or aliases that this Subnet Service Endpoint Storage Policy Definition applies to. ~> **NOTE** The 'service_resources' property must contain either Aliases or Resource IDs, but not both.
